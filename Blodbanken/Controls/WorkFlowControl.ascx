...
<ul class="list-group">
  ...
  <li class="list-group-item" runat="server" id="workflowCreateUser"><b><a href="/WorkflowItems/PersInfoPage.aspx" style="color:inherit;">Oppgi personalia</a></b><span id="errorInfo1" class="pull-right" runat="server"></span></li>  
  <li class="list-group-item" runat="server" id="workflowSchema"><b><a href="/WorkflowItems/QuestionForm.aspx" style="color:inherit;">Spørreskjema før avgivning/Egenerklæring</a></b><span id="errorInfo4" class="pull-right" runat="server"></span></li>
